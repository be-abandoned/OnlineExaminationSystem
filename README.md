...
系统内置了以下演示账号（密码统一为 `OexTest#2026!A1`）：

| 角色 | 手机号 | 学号/工号 | 密码 | 说明 |
| :--- | :--- | :--- | :--- | :--- |
| **教师** | `18800000001` | `T10001` | `OexTest#2026!A1` | 拥有最高管理权限 |
| **学生** | `18800000011` | `S20230001` | `OexTest#2026!A1` | 普通学生账号 |
| **学生** | `18800000012` | `S20230002` | `OexTest#2026!A1` | 另一个学生账号 |
